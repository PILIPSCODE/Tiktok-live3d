...
- **Audio (MP3, Wav)**  
  Import `.mp3, .wav` files for background music, sound effects, or voice interaction.
...
---
   ...
   <img src="/doc/resource.png" className="mt-5" alt="Input Tiktok Username" width="600"/>
