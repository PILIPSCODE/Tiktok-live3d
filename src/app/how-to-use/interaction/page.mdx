...
<div className="nx-bg-gray-100 nx-p-4 nx-rounded-md dark:nx-bg-gray-800">
  <p>Important: All of these interaction settings can be configured through the user interface on your platform. This MDX file serves as a reference and technical documentation.</p>
</div>
...
<Tabs items={['3D Interaction', '2D Interaction']}>
  <Tabs.Tab>
    ...
    - **`Set audio resource`**
      ...
      **Use Case Examples:**
      - Footstep sounds when walking through a virtual environment.
      - Sound effects when a 3D object is selected or clicked.
  ...
  <Tabs.Tab>
    ...
    - **`Add audio and gif resource`**
      ...
      **Use Case Examples:**
      - An animated sticker with a clapping sound.
      - A GIF that is triggered when a user swipes or taps on an image.
